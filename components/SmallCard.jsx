...
const SmallCard = ({ icon, title, text }) => {
  return (
    <div className="w-full cursor-pointer group flex flex-col transition-all duration-700 hover:rotate-12 bg-LightGray rounded-[20px] items-start justify-center p-8 gap-2 hover:bg-black hover:text-white">
